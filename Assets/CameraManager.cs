...
public class CameraManager : MonoBehaviour
{
    ...
    public LayerMask collisionLayers; // layers with which camera will collide // not in awake method rather via inspector
    ...
    private void Awake()
    {
        ...
        cameraTransform = Camera.main.transform;//GetComponent<CameraManager>().transform;
    ...
    {
        float targetPosition = defaultPosition; // camera moves back to default position hwen collided
        RaycastHit hit;
